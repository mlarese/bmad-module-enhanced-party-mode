...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        sanctum = root / "_bmad" / "memory" / "agent-tech-law-counsel"
        if r.returncode != 0 or not (sanctum / "PERSONA.md").is_file():
            ...
            if r2.returncode != 0 or "already exists" not in r2.stdout.lower():
                # script exits 0 with message
