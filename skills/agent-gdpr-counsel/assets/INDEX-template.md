...
- `BOND.md` — who I serve (privacy mandate: jurisdictions, products, preferences, Elena handoff)
- `MEMORY.md` — what I know (curated long-term knowledge)
- `CAPABILITIES.md` — what I can do (built-in + learned abilities + tools)

## Session Logs
- `sessions/` — raw session notes by date (YYYY-MM-DD.md), curated into MEMORY.md on session wind-down
