...
- `last_hue_sectors:` _(settore di tinta dominante per area — rosso · terra · giallo · verde · teal · blu · viola · magenta · neutro. **Mai lo stesso per 3 job di fila**: il nome della famiglia può cambiare mentre l'hue resta. Misura con `palette_guard.py`)_
